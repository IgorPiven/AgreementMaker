...
public class LineHandler {
    ...
    public static Map<String, List<String>> handleLine(Map<String, List<String>> discountsData, List<String> lines) {
        ...
        if (!isDiscounted) {
            JOptionPane.showMessageDialog(null, "Invoice contains no discounts",
        ...
        if (totalDiscount != warehouseDiscountValue) {
            JOptionPane.showMessageDialog(null, "Total amount of discounts does not equal " +
                            "to Central Warehouse Discount value. Check if the invoice contains all discounts uploaded", "Error",
